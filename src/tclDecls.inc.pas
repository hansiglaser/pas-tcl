 ...
 *                                                                         *
 *   Pascal include file translated from the declarations of functions in  *
 *   the platform independent public Tcl API.                              *
 *                                                                         *
...
function Tcl_PkgProvideEx(interp:PTcl_Interp; name:PChar; version:PChar; clientData:ClientData):cint;extdecl;external;
function Tcl_PkgRequireEx(interp:PTcl_Interp; name:PChar; version:PChar; exact:cint; clientDataPtr:PClientData):PChar;extdecl;external;
procedure Tcl_Panic(format:PChar; args:array of const);extdecl;external;
procedure Tcl_Panic(format:PChar);extdecl;external;
function Tcl_Alloc(size:cuint):PChar;extdecl;external;
procedure Tcl_Free(ptr:PChar);extdecl;external;
function Tcl_Realloc(ptr:PChar; size:cuint):PChar;extdecl;external;
function Tcl_DbCkalloc(size:cuint; _file:PChar; line:cint):PChar;extdecl;external;
function Tcl_DbCkfree(ptr:PChar; _file:PChar; line:cint):cint;extdecl;external;
function Tcl_DbCkrealloc(ptr:PChar; size:cuint; _file:PChar; line:cint):PChar;extdecl;external;
procedure Tcl_CreateFileHandler(fd:cint; mask:cint; proc:Tcl_FileProc; clientData:ClientData);extdecl;external;
procedure Tcl_DeleteFileHandler(fd:cint);extdecl;external;
procedure Tcl_SetTimer(timePtr:PTcl_Time);extdecl;external;
procedure Tcl_Sleep(ms:cint);extdecl;external;
function Tcl_WaitForEvent(timePtr:PTcl_Time):cint;extdecl;external;
function Tcl_AppendAllObjTypes(interp:PTcl_Interp; objPtr:PTcl_Obj):cint;extdecl;external;
procedure Tcl_AppendStringsToObj(objPtr:PTcl_Obj; args:array of const);extdecl;external;
procedure Tcl_AppendStringsToObj(objPtr:PTcl_Obj);extdecl;external;
procedure Tcl_AppendToObj(objPtr:PTcl_Obj; bytes:PChar; length:cint);extdecl;external;
function Tcl_ConcatObj(objc:cint; objv:array of PTcl_Obj):PTcl_Obj;extdecl;external;
function Tcl_ConvertToType(interp:PTcl_Interp; objPtr:PTcl_Obj; typePtr:PTcl_ObjType):cint;extdecl;external;
procedure Tcl_DbDecrRefCount(objPtr:PTcl_Obj; _file:PChar; line:cint);extdecl;external;
procedure Tcl_DbIncrRefCount(objPtr:PTcl_Obj; _file:PChar; line:cint);extdecl;external;
function Tcl_DbIsShared(objPtr:PTcl_Obj; _file:PChar; line:cint):cint;extdecl;external;
function Tcl_DbNewBooleanObj(boolValue:cint; _file:PChar; line:cint):PTcl_Obj;extdecl;external;
function Tcl_DbNewByteArrayObj(bytes:pcuchar; length:cint; _file:PChar; line:cint):PTcl_Obj;extdecl;external;
function Tcl_DbNewDoubleObj(doubleValue:double; _file:PChar; line:cint):PTcl_Obj;extdecl;external;
function Tcl_DbNewListObj(objc:cint; objv:PPTcl_Obj; _file:PChar; line:cint):PTcl_Obj;extdecl;external;
function Tcl_DbNewLongObj(longValue:clong; _file:PChar; line:cint):PTcl_Obj;extdecl;external;
function Tcl_DbNewObj(_file:PChar; line:cint):PTcl_Obj;extdecl;external;
function Tcl_DbNewStringObj(bytes:PChar; length:cint; _file:PChar; line:cint):PTcl_Obj;extdecl;external;
function Tcl_DuplicateObj(objPtr:PTcl_Obj):PTcl_Obj;extdecl;external;
procedure TclFreeObj(objPtr:PTcl_Obj);extdecl;external;
function Tcl_GetBoolean(interp:PTcl_Interp; src:PChar; boolPtr:pcint):cint;extdecl;external;
function Tcl_GetBooleanFromObj(interp:PTcl_Interp; objPtr:PTcl_Obj; boolPtr:pcint):cint;extdecl;external;
function Tcl_GetByteArrayFromObj(objPtr:PTcl_Obj; lengthPtr:pcint):pcuchar;extdecl;external;
function Tcl_GetDouble(interp:PTcl_Interp; src:PChar; doublePtr:Pdouble):cint;extdecl;external;
function Tcl_GetDoubleFromObj(interp:PTcl_Interp; objPtr:PTcl_Obj; doublePtr:Pdouble):cint;extdecl;external;
function Tcl_GetIndexFromObj(interp:PTcl_Interp; objPtr:PTcl_Obj; tablePtr:PPChar; msg:PChar; flags:cint;
           indexPtr:pcint):cint;extdecl;external;
function Tcl_GetInt(interp:PTcl_Interp; src:PChar; intPtr:pcint):cint;extdecl;external;
function Tcl_GetIntFromObj(interp:PTcl_Interp; objPtr:PTcl_Obj; Out intPtr:LongInt):cint;extdecl;external;
function Tcl_GetLongFromObj(interp:PTcl_Interp; objPtr:PTcl_Obj; longPtr:pclong):cint;extdecl;external;
function Tcl_GetObjType(typeName:PChar):PTcl_ObjType;extdecl;external;
function Tcl_GetStringFromObj(objPtr:PTcl_Obj; lengthPtr:pcint):PChar;extdecl;external;
procedure Tcl_InvalidateStringRep(objPtr:PTcl_Obj);extdecl;external;
function Tcl_ListObjAppendList(interp:PTcl_Interp; listPtr:PTcl_Obj; elemListPtr:PTcl_Obj):cint;extdecl;external;
function Tcl_ListObjAppendElement(interp:PTcl_Interp; listPtr:PTcl_Obj; objPtr:PTcl_Obj):cint;extdecl;external;
function Tcl_ListObjGetElements(interp:PTcl_Interp; listPtr:PTcl_Obj; Out objc:cint; Out objv:PPTcl_Obj):cint;extdecl;external;
function Tcl_ListObjIndex(interp:PTcl_Interp; listPtr:PTcl_Obj; index:cint; Out objPtr:PTcl_Obj):cint;extdecl;external;
function Tcl_ListObjLength(interp:PTcl_Interp; listPtr:PTcl_Obj; Out lengthPtr:CInt):cint;extdecl;external;
function Tcl_ListObjReplace(interp:PTcl_Interp; listPtr:PTcl_Obj; first:cint; count:cint; objc:cint; 
           objv:PPTcl_Obj):cint;extdecl;external;
function Tcl_NewBooleanObj(boolValue:cint):PTcl_Obj;extdecl;external;
function Tcl_NewByteArrayObj(bytes:pcuchar; length:cint):PTcl_Obj;extdecl;external;
function Tcl_NewDoubleObj(doubleValue:double):PTcl_Obj;extdecl;external;
function Tcl_NewIntObj(intValue:cint):PTcl_Obj;extdecl;external;
function Tcl_NewListObj(objc:cint; objv:PPTcl_Obj):PTcl_Obj;extdecl;external;
function Tcl_NewLongObj(longValue:clong):PTcl_Obj;extdecl;external;
function Tcl_NewObj:PTcl_Obj;extdecl;external;
function Tcl_NewStringObj(bytes:PChar; length:cint):PTcl_Obj;extdecl;external;
procedure Tcl_SetBooleanObj(objPtr:PTcl_Obj; boolValue:cint);extdecl;external;
function Tcl_SetByteArrayLength(objPtr:PTcl_Obj; length:cint):pcuchar;extdecl;external;
procedure Tcl_SetByteArrayObj(objPtr:PTcl_Obj; bytes:pcuchar; length:cint);extdecl;external;
procedure Tcl_SetDoubleObj(objPtr:PTcl_Obj; doubleValue:double);extdecl;external;
procedure Tcl_SetIntObj(objPtr:PTcl_Obj; intValue:cint);extdecl;external;
procedure Tcl_SetListObj(objPtr:PTcl_Obj; objc:cint; objv:PPTcl_Obj);extdecl;external;
procedure Tcl_SetLongObj(objPtr:PTcl_Obj; longValue:clong);extdecl;external;
procedure Tcl_SetObjLength(objPtr:PTcl_Obj; length:cint);extdecl;external;
procedure Tcl_SetStringObj(objPtr:PTcl_Obj; bytes:PChar; length:cint);extdecl;external;
procedure Tcl_AddErrorInfo(interp:PTcl_Interp; message:PChar);extdecl;external;
procedure Tcl_AddObjErrorInfo(interp:PTcl_Interp; message:PChar; length:cint);extdecl;external;
procedure Tcl_AllowExceptions(interp:PTcl_Interp);extdecl;external;
procedure Tcl_AppendElement(interp:PTcl_Interp; element:PChar);extdecl;external;
procedure Tcl_AppendResult(interp:PTcl_Interp; args:array of const);extdecl;external;
function Tcl_AsyncCreate(proc:Tcl_AsyncProc; clientData:ClientData):PTcl_AsyncHandler;extdecl;external;
procedure Tcl_AsyncDelete(async:PTcl_AsyncHandler);extdecl;external;
function Tcl_AsyncInvoke(interp:PTcl_Interp; code:cint):cint;extdecl;external;
procedure Tcl_AsyncMark(async:PTcl_AsyncHandler);extdecl;external;
function Tcl_AsyncReady:cint;extdecl;external;
procedure Tcl_BackgroundError(interp:PTcl_Interp);extdecl;external;
function Tcl_Backslash(src:PChar; readPtr:pcint):cchar;extdecl;external;
function Tcl_BadChannelOption(interp:PTcl_Interp; optionName:PChar; optionList:PChar):cint;extdecl;external;
procedure Tcl_CallWhenDeleted(interp:PTcl_Interp; proc:Tcl_InterpDeleteProc; clientData:ClientData);extdecl;external;
procedure Tcl_CancelIdleCall(idleProc:Tcl_IdleProc; clientData:ClientData);extdecl;external;
function Tcl_Close(interp:PTcl_Interp; chan:PTcl_Channel):cint;extdecl;external;
function Tcl_CommandComplete(cmd:PChar):cint;extdecl;external;
function Tcl_Concat(argc:cint; argv:PPChar):PChar;extdecl;external;
function Tcl_ConvertElement(src:PChar; dst:PChar; flags:cint):cint;extdecl;external;
function Tcl_ConvertCountedElement(src:PChar; length:cint; dst:PChar; flags:cint):cint;extdecl;external;
function Tcl_CreateAlias(slave:PTcl_Interp; slaveCmd:PChar; target:PTcl_Interp; targetCmd:PChar; argc:cint;
           argv:PPChar):cint;extdecl;external;
function Tcl_CreateAliasObj(slave:PTcl_Interp; slaveCmd:PChar; target:PTcl_Interp; targetCmd:PChar; objc:cint;
           objv:array of PTcl_Obj):cint;extdecl;external;
function Tcl_CreateChannel(typePtr:PTcl_ChannelType; chanName:PChar; instanceData:ClientData; mask:cint):PTcl_Channel;extdecl;external;
procedure Tcl_CreateChannelHandler(chan:PTcl_Channel; mask:cint; proc:Tcl_ChannelProc; clientData:ClientData);extdecl;external;
procedure Tcl_CreateCloseHandler(chan:PTcl_Channel; proc:Tcl_CloseProc; clientData:ClientData);extdecl;external;
function Tcl_CreateCommand(interp:PTcl_Interp; cmdName:PChar; proc:Tcl_CmdProc; clientData:ClientData; deleteProc:Tcl_CmdDeleteProc):PTcl_Command;extdecl;external;
procedure Tcl_CreateEventSource(setupProc:Tcl_EventSetupProc; checkProc:Tcl_EventCheckProc; clientData:ClientData);extdecl;external;
procedure Tcl_CreateExitHandler(proc:Tcl_ExitProc; clientData:ClientData);extdecl;external;
function Tcl_CreateInterp:PTcl_Interp;extdecl;external;
procedure Tcl_CreateMathFunc(interp:PTcl_Interp; name:PChar; numArgs:cint; argTypes:PTcl_ValueType; proc:Tcl_MathProc;
            clientData:ClientData);extdecl;external;
function Tcl_CreateObjCommand(interp:PTcl_Interp; cmdName:PChar; proc:Tcl_ObjCmdProc; clientData:ClientData; deleteProc:Tcl_CmdDeleteProc):PTcl_Command;extdecl;external;
function Tcl_CreateSlave(interp:PTcl_Interp; slaveName:PChar; isSafe:cint):PTcl_Interp;extdecl;external;
function Tcl_CreateTimerHandler(milliseconds:cint; proc:Tcl_TimerProc; clientData:ClientData):PTcl_TimerToken;extdecl;external;
function Tcl_CreateTrace(interp:PTcl_Interp; level:cint; proc:Tcl_CmdTraceProc; clientData:ClientData):PTcl_Trace;extdecl;external;
procedure Tcl_DeleteAssocData(interp:PTcl_Interp; name:PChar);extdecl;external;
procedure Tcl_DeleteChannelHandler(chan:PTcl_Channel; proc:Tcl_ChannelProc; clientData:ClientData);extdecl;external;
procedure Tcl_DeleteCloseHandler(chan:PTcl_Channel; proc:Tcl_CloseProc; clientData:ClientData);extdecl;external;
function Tcl_DeleteCommand(interp:PTcl_Interp; cmdName:PChar):cint;extdecl;external;
function Tcl_DeleteCommandFromToken(interp:PTcl_Interp; command:PTcl_Command):cint;extdecl;external;
procedure Tcl_DeleteEvents(proc:Tcl_EventDeleteProc; clientData:ClientData);extdecl;external;
procedure Tcl_DeleteEventSource(setupProc:Tcl_EventSetupProc; checkProc:Tcl_EventCheckProc; clientData:ClientData);extdecl;external;
procedure Tcl_DeleteExitHandler(proc:Tcl_ExitProc; clientData:ClientData);extdecl;external;
procedure Tcl_DeleteHashEntry(entryPtr:PTcl_HashEntry);extdecl;external;
procedure Tcl_DeleteHashTable(tablePtr:PTcl_HashTable);extdecl;external;
procedure Tcl_DeleteInterp(interp:PTcl_Interp);extdecl;external;
procedure Tcl_DetachPids(numPids:cint; pidPtr:PTcl_Pid);extdecl;external;
procedure Tcl_DeleteTimerHandler(token:PTcl_TimerToken);extdecl;external;
procedure Tcl_DeleteTrace(interp:PTcl_Interp; trace:PTcl_Trace);extdecl;external;
procedure Tcl_DontCallWhenDeleted(interp:PTcl_Interp; proc:Tcl_InterpDeleteProc; clientData:ClientData);extdecl;external;
function Tcl_DoOneEvent(flags:cint):cint;extdecl;external;
procedure Tcl_DoWhenIdle(proc:Tcl_IdleProc; clientData:ClientData);extdecl;external;
function Tcl_DStringAppend(dsPtr:PTcl_DString; bytes:PChar; length:cint):PChar;extdecl;external;
function Tcl_DStringAppendElement(dsPtr:PTcl_DString; element:PChar):PChar;extdecl;external;
procedure Tcl_DStringEndSublist(dsPtr:PTcl_DString);extdecl;external;
procedure Tcl_DStringFree(dsPtr:PTcl_DString);extdecl;external;
procedure Tcl_DStringGetResult(interp:PTcl_Interp; dsPtr:PTcl_DString);extdecl;external;
procedure Tcl_DStringInit(dsPtr:PTcl_DString);extdecl;external;
procedure Tcl_DStringResult(interp:PTcl_Interp; dsPtr:PTcl_DString);extdecl;external;
procedure Tcl_DStringSetLength(dsPtr:PTcl_DString; length:cint);extdecl;external;
procedure Tcl_DStringStartSublist(dsPtr:PTcl_DString);extdecl;external;
function Tcl_Eof(chan:PTcl_Channel):cint;extdecl;external;
function Tcl_ErrnoId:PChar;extdecl;external;
function Tcl_ErrnoMsg(err:cint):PChar;extdecl;external;
function Tcl_Eval(interp:PTcl_Interp; script:PChar):cint;extdecl;external;
function Tcl_EvalFile(interp:PTcl_Interp; fileName:PChar):cint;extdecl;external;
function Tcl_EvalObj(interp:PTcl_Interp; objPtr:PTcl_Obj):cint;extdecl;external;
procedure Tcl_EventuallyFree(clientData:ClientData; freeProc:Tcl_FreeProc);extdecl;external;
procedure Tcl_Exit(status:cint);extdecl;external;
function Tcl_ExposeCommand(interp:PTcl_Interp; hiddenCmdToken:PChar; cmdName:PChar):cint;extdecl;external;
function Tcl_ExprBoolean(interp:PTcl_Interp; expr:PChar; ptr:pcint):cint;extdecl;external;
function Tcl_ExprBooleanObj(interp:PTcl_Interp; objPtr:PTcl_Obj; ptr:pcint):cint;extdecl;external;
function Tcl_ExprDouble(interp:PTcl_Interp; expr:PChar; ptr:Pdouble):cint;extdecl;external;
function Tcl_ExprDoubleObj(interp:PTcl_Interp; objPtr:PTcl_Obj; ptr:Pdouble):cint;extdecl;external;
function Tcl_ExprLong(interp:PTcl_Interp; expr:PChar; ptr:pclong):cint;extdecl;external;
function Tcl_ExprLongObj(interp:PTcl_Interp; objPtr:PTcl_Obj; ptr:pclong):cint;extdecl;external;
function Tcl_ExprObj(interp:PTcl_Interp; objPtr:PTcl_Obj; resultPtrPtr:PPTcl_Obj):cint;extdecl;external;
function Tcl_ExprString(interp:PTcl_Interp; expr:PChar):cint;extdecl;external;
procedure Tcl_Finalize;extdecl;external;
procedure Tcl_FindExecutable(argv0:PChar);extdecl;external;
function Tcl_FirstHashEntry(tablePtr:PTcl_HashTable; searchPtr:PTcl_HashSearch):PTcl_HashEntry;extdecl;external;
function Tcl_Flush(chan:PTcl_Channel):cint;extdecl;external;
procedure Tcl_FreeResult(interp:PTcl_Interp);extdecl;external;
function Tcl_GetAlias(interp:PTcl_Interp; slaveCmd:PChar; targetInterpPtr:PPTcl_Interp; targetCmdPtr:PPChar; argcPtr:pcint;
           argvPtr:PPPChar):cint;extdecl;external;
function Tcl_GetAliasObj(interp:PTcl_Interp; slaveCmd:PChar; targetInterpPtr:PPTcl_Interp; targetCmdPtr:PPChar; objcPtr:pcint;
           objv:PPPTcl_Obj):cint;extdecl;external;
function Tcl_GetAssocData(interp:PTcl_Interp; name:PChar; procPtr:Tcl_InterpDeleteProc):ClientData;extdecl;external;
function Tcl_GetChannel(interp:PTcl_Interp; chanName:PChar; modePtr:pcint):PTcl_Channel;extdecl;external;
function Tcl_GetChannelBufferSize(chan:PTcl_Channel):cint;extdecl;external;
function Tcl_GetChannelHandle(chan:PTcl_Channel; direction:cint; handlePtr:PClientData):cint;extdecl;external;
function Tcl_GetChannelInstanceData(chan:PTcl_Channel):ClientData;extdecl;external;
function Tcl_GetChannelMode(chan:PTcl_Channel):cint;extdecl;external;
function Tcl_GetChannelName(chan:PTcl_Channel):PChar;extdecl;external;
function Tcl_GetChannelOption(interp:PTcl_Interp; chan:PTcl_Channel; optionName:PChar; dsPtr:PTcl_DString):cint;extdecl;external;
function Tcl_GetChannelType(chan:PTcl_Channel):PTcl_ChannelType;extdecl;external;
function Tcl_GetCommandInfo(interp:PTcl_Interp; cmdName:PChar; infoPtr:PTcl_CmdInfo):cint;extdecl;external;
function Tcl_GetCommandName(interp:PTcl_Interp; command:PTcl_Command):PChar;extdecl;external;
function Tcl_GetErrno:cint;extdecl;external;
function Tcl_GetHostName:PChar;extdecl;external;
function Tcl_GetInterpPath(askInterp:PTcl_Interp; slaveInterp:PTcl_Interp):cint;extdecl;external;
function Tcl_GetMaster(interp:PTcl_Interp):PTcl_Interp;extdecl;external;
function Tcl_GetNameOfExecutable:PChar;extdecl;external;
function Tcl_GetObjResult(interp:PTcl_Interp):PTcl_Obj;extdecl;external;
function Tcl_GetOpenFile(interp:PTcl_Interp; chanID:PChar; forWriting:cint; checkUsage:cint; filePtr:PClientData):cint;extdecl;external;
function Tcl_GetPathType(path:PChar):Tcl_PathType;extdecl;external;
function Tcl_Gets(chan:PTcl_Channel; dsPtr:PTcl_DString):cint;extdecl;external;
function Tcl_GetsObj(chan:PTcl_Channel; objPtr:PTcl_Obj):cint;extdecl;external;
function Tcl_GetServiceMode:cint;extdecl;external;
function Tcl_GetSlave(interp:PTcl_Interp; slaveName:PChar):PTcl_Interp;extdecl;external;
function Tcl_GetStdChannel(_type:cint):PTcl_Channel;extdecl;external;
function Tcl_GetStringResult(interp:PTcl_Interp):PChar;extdecl;external;
function Tcl_GetVar(interp:PTcl_Interp; varName:PChar; flags:cint):PChar;extdecl;external;
function Tcl_GetVar2(interp:PTcl_Interp; part1:PChar; part2:PChar; flags:cint):PChar;extdecl;external;
function Tcl_GlobalEval(interp:PTcl_Interp; command:PChar):cint;extdecl;external;
function Tcl_GlobalEvalObj(interp:PTcl_Interp; objPtr:PTcl_Obj):cint;extdecl;external;
function Tcl_HideCommand(interp:PTcl_Interp; cmdName:PChar; hiddenCmdToken:PChar):cint;extdecl;external;
function Tcl_Init(interp:PTcl_Interp):cint;extdecl;external;
procedure Tcl_InitHashTable(tablePtr:PTcl_HashTable; keyType:cint);extdecl;external;
function Tcl_InputBlocked(chan:PTcl_Channel):cint;extdecl;external;
function Tcl_InputBuffered(chan:PTcl_Channel):cint;extdecl;external;
function Tcl_InterpDeleted(interp:PTcl_Interp):cint;extdecl;external;
function Tcl_IsSafe(interp:PTcl_Interp):cint;extdecl;external;
function Tcl_JoinPath(argc:cint; argv:PPChar; resultPtr:PTcl_DString):PChar;extdecl;external;
function Tcl_LinkVar(interp:PTcl_Interp; varName:PChar; addr:PChar; _type:cint):cint;extdecl;external;
function Tcl_MakeFileChannel(handle:ClientData; mode:cint):PTcl_Channel;extdecl;external;
function Tcl_MakeSafe(interp:PTcl_Interp):cint;extdecl;external;
function Tcl_MakeTcpClientChannel(tcpSocket:ClientData):PTcl_Channel;extdecl;external;
function Tcl_Merge(argc:cint; argv:PPChar):PChar;extdecl;external;
function Tcl_NextHashEntry(searchPtr:PTcl_HashSearch):PTcl_HashEntry;extdecl;external;
procedure Tcl_NotifyChannel(channel:PTcl_Channel; mask:cint);extdecl;external;
function Tcl_ObjGetVar2(interp:PTcl_Interp; part1Ptr:PTcl_Obj; part2Ptr:PTcl_Obj; flags:cint):PTcl_Obj;extdecl;external;
function Tcl_ObjSetVar2(interp:PTcl_Interp; part1Ptr:PTcl_Obj; part2Ptr:PTcl_Obj; newValuePtr:PTcl_Obj; flags:cint):PTcl_Obj;extdecl;external;
function Tcl_OpenCommandChannel(interp:PTcl_Interp; argc:cint; argv:PPChar; flags:cint):PTcl_Channel;extdecl;external;
function Tcl_OpenFileChannel(interp:PTcl_Interp; fileName:PChar; modeString:PChar; permissions:cint):PTcl_Channel;extdecl;external;
function Tcl_OpenTcpClient(interp:PTcl_Interp; port:cint; address:PChar; myaddr:PChar; myport:cint;
           async:cint):PTcl_Channel;extdecl;external;
function Tcl_OpenTcpServer(interp:PTcl_Interp; port:cint; host:PChar; acceptProc:Tcl_TcpAcceptProc; callbackData:ClientData):PTcl_Channel;extdecl;external;
procedure Tcl_Preserve(data:ClientData);extdecl;external;
procedure Tcl_PrintDouble(interp:PTcl_Interp; value:double; dst:PChar);extdecl;external;
function Tcl_PutEnv(assignment:PChar):cint;extdecl;external;
function Tcl_PosixError(interp:PTcl_Interp):PChar;extdecl;external;
procedure Tcl_QueueEvent(evPtr:PTcl_Event; position:Tcl_QueuePosition);extdecl;external;
function Tcl_Read(chan:PTcl_Channel; bufPtr:PChar; toRead:cint):cint;extdecl;external;
procedure Tcl_ReapDetachedProcs;extdecl;external;
function Tcl_RecordAndEval(interp:PTcl_Interp; cmd:PChar; flags:cint):cint;extdecl;external;
function Tcl_RecordAndEvalObj(interp:PTcl_Interp; cmdPtr:PTcl_Obj; flags:cint):cint;extdecl;external;
procedure Tcl_RegisterChannel(interp:PTcl_Interp; chan:PTcl_Channel);extdecl;external;
procedure Tcl_RegisterObjType(typePtr:PTcl_ObjType);extdecl;external;
function Tcl_RegExpCompile(interp:PTcl_Interp; pattern:PChar):PTcl_RegExp;extdecl;external;
function Tcl_RegExpExec(interp:PTcl_Interp; regexp:PTcl_RegExp; text:PChar; start:PChar):cint;extdecl;external;
function Tcl_RegExpMatch(interp:PTcl_Interp; text:PChar; pattern:PChar):cint;extdecl;external;
procedure Tcl_RegExpRange(regexp:PTcl_RegExp; index:cint; startPtr:PPChar; endPtr:PPChar);extdecl;external;
procedure Tcl_Release(clientData:ClientData);extdecl;external;
procedure Tcl_ResetResult(interp:PTcl_Interp);extdecl;external;
function Tcl_ScanElement(str:PChar; flagPtr:pcint):cint;extdecl;external;
function Tcl_ScanCountedElement(str:PChar; length:cint; flagPtr:pcint):cint;extdecl;external;
function Tcl_SeekOld(chan:PTcl_Channel; offset:cint; mode:cint):cint;extdecl;external;
function Tcl_ServiceAll:cint;extdecl;external;
function Tcl_ServiceEvent(flags:cint):cint;extdecl;external;
procedure Tcl_SetAssocData(interp:PTcl_Interp; name:PChar; proc:Tcl_InterpDeleteProc; clientData:ClientData);extdecl;external;
procedure Tcl_SetChannelBufferSize(chan:PTcl_Channel; sz:cint);extdecl;external;
function Tcl_SetChannelOption(interp:PTcl_Interp; chan:PTcl_Channel; optionName:PChar; newValue:PChar):cint;extdecl;external;
function Tcl_SetCommandInfo(interp:PTcl_Interp; cmdName:PChar; infoPtr:PTcl_CmdInfo):cint;extdecl;external;
procedure Tcl_SetErrno(err:cint);extdecl;external;
procedure Tcl_SetErrorCode(interp:PTcl_Interp; args:array of const);extdecl;external;
procedure Tcl_SetErrorCode(interp:PTcl_Interp);extdecl;external;
procedure Tcl_SetMaxBlockTime(timePtr:PTcl_Time);extdecl;external;
procedure Tcl_SetPanicProc(panicProc:Tcl_PanicProc);extdecl;external;
function Tcl_SetRecursionLimit(interp:PTcl_Interp; depth:cint):cint;extdecl;external;
procedure Tcl_SetResult(interp:PTcl_Interp; result:PChar; freeProc:Tcl_FreeProc);extdecl;external;
function Tcl_SetServiceMode(mode:cint):cint;extdecl;external;
procedure Tcl_SetObjErrorCode(interp:PTcl_Interp; errorObjPtr:PTcl_Obj);extdecl;external;
procedure Tcl_SetObjResult(interp:PTcl_Interp; resultObjPtr:PTcl_Obj);extdecl;external;
procedure Tcl_SetStdChannel(channel:PTcl_Channel; _type:cint);extdecl;external;
function Tcl_SetVar(interp:PTcl_Interp; varName:PChar; newValue:PChar; flags:cint):PChar;extdecl;external;
function Tcl_SetVar2(interp:PTcl_Interp; part1:PChar; part2:PChar; newValue:PChar; flags:cint):PChar;extdecl;external;
function Tcl_SignalId(sig:cint):PChar;extdecl;external;
function Tcl_SignalMsg(sig:cint):PChar;extdecl;external;
procedure Tcl_SourceRCFile(interp:PTcl_Interp);extdecl;external;
function Tcl_SplitList(interp:PTcl_Interp; listStr:PChar; argcPtr:pcint; argvPtr:PPPChar):cint;extdecl;external;
procedure Tcl_SplitPath(path:PChar; argcPtr:pcint; argvPtr:PPPChar);extdecl;external;
procedure Tcl_StaticPackage(interp:PTcl_Interp; pkgName:PChar; initProc:Tcl_PackageInitProc; safeInitProc:Tcl_PackageInitProc);extdecl;external;
function Tcl_StringMatch(str:PChar; pattern:PChar):cint;extdecl;external;
function Tcl_TellOld(chan:PTcl_Channel):cint;extdecl;external;
function Tcl_TraceVar(interp:PTcl_Interp; varName:PChar; flags:cint; proc:Tcl_VarTraceProc; clientData:ClientData):cint;extdecl;external;
function Tcl_TraceVar2(interp:PTcl_Interp; part1:PChar; part2:PChar; flags:cint; proc:Tcl_VarTraceProc;
           clientData:ClientData):cint;extdecl;external;
function Tcl_TranslateFileName(interp:PTcl_Interp; name:PChar; bufferPtr:PTcl_DString):PChar;extdecl;external;
function Tcl_Ungets(chan:PTcl_Channel; str:PChar; len:cint; atHead:cint):cint;extdecl;external;
procedure Tcl_UnlinkVar(interp:PTcl_Interp; varName:PChar);extdecl;external;
function Tcl_UnregisterChannel(interp:PTcl_Interp; chan:PTcl_Channel):cint;extdecl;external;
function Tcl_UnsetVar(interp:PTcl_Interp; varName:PChar; flags:cint):cint;extdecl;external;
function Tcl_UnsetVar2(interp:PTcl_Interp; part1:PChar; part2:PChar; flags:cint):cint;extdecl;external;
procedure Tcl_UntraceVar(interp:PTcl_Interp; varName:PChar; flags:cint; proc:Tcl_VarTraceProc; clientData:ClientData);extdecl;external;
procedure Tcl_UntraceVar2(interp:PTcl_Interp; part1:PChar; part2:PChar; flags:cint; proc:Tcl_VarTraceProc;
            clientData:ClientData);extdecl;external;
procedure Tcl_UpdateLinkedVar(interp:PTcl_Interp; varName:PChar);extdecl;external;
function Tcl_UpVar(interp:PTcl_Interp; frameName:PChar; varName:PChar; localName:PChar; flags:cint):cint;extdecl;external;
function Tcl_UpVar2(interp:PTcl_Interp; frameName:PChar; part1:PChar; part2:PChar; localName:PChar;
           flags:cint):cint;extdecl;external;
function Tcl_VarEval(interp:PTcl_Interp; args:array of const):cint;extdecl;external;
function Tcl_VarEval(interp:PTcl_Interp):cint;extdecl;external;
function Tcl_VarTraceInfo(interp:PTcl_Interp; varName:PChar; flags:cint; procPtr:Tcl_VarTraceProc; prevClientData:ClientData):ClientData;extdecl;external;
function Tcl_VarTraceInfo2(interp:PTcl_Interp; part1:PChar; part2:PChar; flags:cint; procPtr:Tcl_VarTraceProc;
           prevClientData:ClientData):ClientData;extdecl;external;
function Tcl_Write(chan:PTcl_Channel; s:PChar; slen:cint):cint;extdecl;external;
procedure Tcl_WrongNumArgs(interp:PTcl_Interp; objc:cint; objv:array of PTcl_Obj; message:PChar);extdecl;external;
function Tcl_DumpActiveMemory(fileName:PChar):cint;extdecl;external;
procedure Tcl_ValidateAllMemory(_file:PChar; line:cint);extdecl;external;
procedure Tcl_AppendResultVA(interp:PTcl_Interp; argList:Pointer{va_list});extdecl;external;
procedure Tcl_AppendStringsToObjVA(objPtr:PTcl_Obj; argList:Pointer{va_list});extdecl;external;
function Tcl_HashStats(tablePtr:PTcl_HashTable):PChar;extdecl;external;
function Tcl_ParseVar(interp:PTcl_Interp; start:PChar; termPtr:PPChar):PChar;extdecl;external;
function Tcl_PkgPresent(interp:PTcl_Interp; name:PChar; version:PChar; exact:cint):PChar;extdecl;external;
function Tcl_PkgPresentEx(interp:PTcl_Interp; name:PChar; version:PChar; exact:cint; clientDataPtr:PClientData):PChar;extdecl;external;
function Tcl_PkgProvide(interp:PTcl_Interp; name:PChar; version:PChar):cint;extdecl;external;
function Tcl_PkgRequire(interp:PTcl_Interp; name:PChar; version:PChar; exact:cint):PChar;extdecl;external;
procedure Tcl_SetErrorCodeVA(interp:PTcl_Interp; argList:Pointer{va_list});extdecl;external;
function Tcl_VarEvalVA(interp:PTcl_Interp; argList:Pointer{va_list}):cint;extdecl;external;
function Tcl_WaitPid(pid:PTcl_Pid; statPtr:pcint; options:cint):PTcl_Pid;extdecl;external;
procedure Tcl_PanicVA(format:PChar; argList:Pointer{va_list});extdecl;external;
procedure Tcl_GetVersion(major:pcint; minor:pcint; patchLevel:pcint; _type:pcint);extdecl;external;
procedure Tcl_InitMemory(interp:PTcl_Interp);extdecl;external;
function Tcl_StackChannel(interp:PTcl_Interp; typePtr:PTcl_ChannelType; instanceData:ClientData; mask:cint; prevChan:PTcl_Channel):PTcl_Channel;extdecl;external;
function Tcl_UnstackChannel(interp:PTcl_Interp; chan:PTcl_Channel):cint;extdecl;external;
function Tcl_GetStackedChannel(chan:PTcl_Channel):PTcl_Channel;extdecl;external;
procedure Tcl_SetMainLoop(proc:Tcl_MainLoopProc);extdecl;external;
procedure Tcl_AppendObjToObj(objPtr:PTcl_Obj; appendObjPtr:PTcl_Obj);extdecl;external;
function Tcl_CreateEncoding(typePtr:PTcl_EncodingType):PTcl_Encoding;extdecl;external;
procedure Tcl_CreateThreadExitHandler(proc:Tcl_ExitProc; clientData:ClientData);extdecl;external;
procedure Tcl_DeleteThreadExitHandler(proc:Tcl_ExitProc; clientData:ClientData);extdecl;external;
procedure Tcl_DiscardResult(statePtr:PTcl_SavedResult);extdecl;external;
function Tcl_EvalEx(interp:PTcl_Interp; script:PChar; numBytes:cint; flags:cint):cint;extdecl;external;
function Tcl_EvalObjv(interp:PTcl_Interp; objc:cint; objv:array of PTcl_Obj; flags:cint):cint;extdecl;external;
function Tcl_EvalObjEx(interp:PTcl_Interp; objPtr:PTcl_Obj; flags:cint):cint;extdecl;external;
procedure Tcl_ExitThread(status:cint);extdecl;external;
function Tcl_ExternalToUtf(interp:PTcl_Interp; encoding:PTcl_Encoding; src:PChar; srcLen:cint; flags:cint;
           ...
           dstCharsPtr:pcint):cint;extdecl;external;
function Tcl_ExternalToUtfDString(encoding:PTcl_Encoding; src:PChar; srcLen:cint; dsPtr:PTcl_DString):PChar;extdecl;external;
procedure Tcl_FinalizeThread;extdecl;external;
procedure Tcl_FinalizeNotifier(clientData:ClientData);extdecl;external;
procedure Tcl_FreeEncoding(encoding:PTcl_Encoding);extdecl;external;
function Tcl_GetCurrentThread:PTcl_ThreadId;extdecl;external;
function Tcl_GetEncoding(interp:PTcl_Interp; name:PChar):PTcl_Encoding;extdecl;external;
function Tcl_GetEncodingName(encoding:PTcl_Encoding):PChar;extdecl;external;
procedure Tcl_GetEncodingNames(interp:PTcl_Interp);extdecl;external;
function Tcl_GetIndexFromObjStruct(interp:PTcl_Interp; objPtr:PTcl_Obj; tablePtr:pointer; offset:cint; msg:PChar;
           flags:cint; indexPtr:pcint):cint;extdecl;external;
function Tcl_GetThreadData(keyPtr:PTcl_ThreadDataKey; size:cint):pointer;extdecl;external;
function Tcl_GetVar2Ex(interp:PTcl_Interp; part1:PChar; part2:PChar; flags:cint):PTcl_Obj;extdecl;external;
function Tcl_InitNotifier:ClientData;extdecl;external;
procedure Tcl_MutexLock(mutexPtr:PTcl_Mutex);extdecl;external;
procedure Tcl_MutexUnlock(mutexPtr:PTcl_Mutex);extdecl;external;
procedure Tcl_ConditionNotify(condPtr:PTcl_Condition);extdecl;external;
procedure Tcl_ConditionWait(condPtr:PTcl_Condition; mutexPtr:PTcl_Mutex; timePtr:PTcl_Time);extdecl;external;
function Tcl_NumUtfChars(src:PChar; length:cint):cint;extdecl;external;
function Tcl_ReadChars(channel:PTcl_Channel; objPtr:PTcl_Obj; charsToRead:cint; appendFlag:cint):cint;extdecl;external;
procedure Tcl_RestoreResult(interp:PTcl_Interp; statePtr:PTcl_SavedResult);extdecl;external;
procedure Tcl_SaveResult(interp:PTcl_Interp; statePtr:PTcl_SavedResult);extdecl;external;
function Tcl_SetSystemEncoding(interp:PTcl_Interp; name:PChar):cint;extdecl;external;
function Tcl_SetVar2Ex(interp:PTcl_Interp; part1:PChar; part2:PChar; newValuePtr:PTcl_Obj; flags:cint):PTcl_Obj;extdecl;external;
procedure Tcl_ThreadAlert(threadId:PTcl_ThreadId);extdecl;external;
procedure Tcl_ThreadQueueEvent(threadId:PTcl_ThreadId; evPtr:PTcl_Event; position:Tcl_QueuePosition);extdecl;external;
function Tcl_UniCharAtIndex(src:PChar; index:cint):Tcl_UniChar;extdecl;external;
function Tcl_UniCharToLower(ch:cint):Tcl_UniChar;extdecl;external;
function Tcl_UniCharToTitle(ch:cint):Tcl_UniChar;extdecl;external;
function Tcl_UniCharToUpper(ch:cint):Tcl_UniChar;extdecl;external;
function Tcl_UniCharToUtf(ch:cint; buf:PChar):cint;extdecl;external;
function Tcl_UtfAtIndex(src:PChar; index:cint):PChar;extdecl;external;
function Tcl_UtfCharComplete(src:PChar; length:cint):cint;extdecl;external;
function Tcl_UtfBackslash(src:PChar; readPtr:pcint; dst:PChar):cint;extdecl;external;
function Tcl_UtfFindFirst(src:PChar; ch:cint):PChar;extdecl;external;
function Tcl_UtfFindLast(src:PChar; ch:cint):PChar;extdecl;external;
function Tcl_UtfNext(src:PChar):PChar;extdecl;external;
function Tcl_UtfPrev(src:PChar; start:PChar):PChar;extdecl;external;
function Tcl_UtfToExternal(interp:PTcl_Interp; encoding:PTcl_Encoding; src:PChar; srcLen:cint; flags:cint;
           statePtr:PTcl_EncodingState; dst:PChar; dstLen:cint; srcReadPtr:pcint; dstWrotePtr:pcint;
           dstCharsPtr:pcint):cint;extdecl;external;
function Tcl_UtfToExternalDString(encoding:PTcl_Encoding; src:PChar; srcLen:cint; dsPtr:PTcl_DString):PChar;extdecl;external;
function Tcl_UtfToLower(src:PChar):cint;extdecl;external;
function Tcl_UtfToTitle(src:PChar):cint;extdecl;external;
function Tcl_UtfToUniChar(src:PChar; chPtr:PTcl_UniChar):cint;extdecl;external;
function Tcl_UtfToUpper(src:PChar):cint;extdecl;external;
function Tcl_WriteChars(chan:PTcl_Channel; src:PChar; srcLen:cint):cint;extdecl;external;
function Tcl_WriteObj(chan:PTcl_Channel; objPtr:PTcl_Obj):cint;extdecl;external;
function Tcl_GetString(objPtr:PTcl_Obj):PChar;extdecl;external;
function Tcl_GetDefaultEncodingDir:PChar;extdecl;external;
procedure Tcl_SetDefaultEncodingDir(path:PChar);extdecl;external;
procedure Tcl_AlertNotifier(clientData:ClientData);extdecl;external;
procedure Tcl_ServiceModeHook(mode:cint);extdecl;external;
function Tcl_UniCharIsAlnum(ch:cint):cint;extdecl;external;
function Tcl_UniCharIsAlpha(ch:cint):cint;extdecl;external;
function Tcl_UniCharIsDigit(ch:cint):cint;extdecl;external;
function Tcl_UniCharIsLower(ch:cint):cint;extdecl;external;
function Tcl_UniCharIsSpace(ch:cint):cint;extdecl;external;
function Tcl_UniCharIsUpper(ch:cint):cint;extdecl;external;
function Tcl_UniCharIsWordChar(ch:cint):cint;extdecl;external;
function Tcl_UniCharLen(uniStr:PTcl_UniChar):cint;extdecl;external;
function Tcl_UniCharNcmp(ucs:PTcl_UniChar; uct:PTcl_UniChar; numChars:culong):cint;extdecl;external;
function Tcl_UniCharToUtfDString(uniStr:PTcl_UniChar; uniLength:cint; dsPtr:PTcl_DString):PChar;extdecl;external;
function Tcl_UtfToUniCharDString(src:PChar; length:cint; dsPtr:PTcl_DString):PTcl_UniChar;extdecl;external;
function Tcl_GetRegExpFromObj(interp:PTcl_Interp; patObj:PTcl_Obj; flags:cint):PTcl_RegExp;extdecl;external;
function Tcl_EvalTokens(interp:PTcl_Interp; tokenPtr:PTcl_Token; count:cint):PTcl_Obj;extdecl;external;
procedure Tcl_FreeParse(parsePtr:PTcl_Parse);extdecl;external;
procedure Tcl_LogCommandInfo(interp:PTcl_Interp; script:PChar; command:PChar; length:cint);extdecl;external;
function Tcl_ParseBraces(interp:PTcl_Interp; start:PChar; numBytes:cint; parsePtr:PTcl_Parse; append:cint;
           termPtr:PPChar):cint;extdecl;external;
function Tcl_ParseCommand(interp:PTcl_Interp; start:PChar; numBytes:cint; nested:cint; parsePtr:PTcl_Parse):cint;extdecl;external;
function Tcl_ParseExpr(interp:PTcl_Interp; start:PChar; numBytes:cint; parsePtr:PTcl_Parse):cint;extdecl;external;
function Tcl_ParseQuotedString(interp:PTcl_Interp; start:PChar; numBytes:cint; parsePtr:PTcl_Parse; append:cint;
           termPtr:PPChar):cint;extdecl;external;
function Tcl_ParseVarName(interp:PTcl_Interp; start:PChar; numBytes:cint; parsePtr:PTcl_Parse; append:cint):cint;extdecl;external;
function Tcl_GetCwd(interp:PTcl_Interp; cwdPtr:PTcl_DString):PChar;extdecl;external;
function Tcl_Chdir(dirName:PChar):cint;extdecl;external;
function Tcl_Access(path:PChar; mode:cint):cint;extdecl;external;
function Tcl_Stat(path:PChar; bufPtr:Pstat):cint;extdecl;external;
function Tcl_UtfNcmp(s1:PChar; s2:PChar; n:culong):cint;extdecl;external;
function Tcl_UtfNcasecmp(s1:PChar; s2:PChar; n:culong):cint;extdecl;external;
function Tcl_StringCaseMatch(str:PChar; pattern:PChar; nocase:cint):cint;extdecl;external;
function Tcl_UniCharIsControl(ch:cint):cint;extdecl;external;
function Tcl_UniCharIsGraph(ch:cint):cint;extdecl;external;
function Tcl_UniCharIsPrint(ch:cint):cint;extdecl;external;
function Tcl_UniCharIsPunct(ch:cint):cint;extdecl;external;
function Tcl_RegExpExecObj(interp:PTcl_Interp; regexp:PTcl_RegExp; textObj:PTcl_Obj; offset:cint; nmatches:cint;
           flags:cint):cint;extdecl;external;
procedure Tcl_RegExpGetInfo(regexp:PTcl_RegExp; infoPtr:PTcl_RegExpInfo);extdecl;external;
function Tcl_NewUnicodeObj(unicode:PTcl_UniChar; numChars:cint):PTcl_Obj;extdecl;external;
procedure Tcl_SetUnicodeObj(objPtr:PTcl_Obj; unicode:PTcl_UniChar; numChars:cint);extdecl;external;
function Tcl_GetCharLength(objPtr:PTcl_Obj):cint;extdecl;external;
function Tcl_GetUniChar(objPtr:PTcl_Obj; index:cint):Tcl_UniChar;extdecl;external;
function Tcl_GetUnicode(objPtr:PTcl_Obj):PTcl_UniChar;extdecl;external;
function Tcl_GetRange(objPtr:PTcl_Obj; first:cint; last:cint):PTcl_Obj;extdecl;external;
procedure Tcl_AppendUnicodeToObj(objPtr:PTcl_Obj; unicode:PTcl_UniChar; length:cint);extdecl;external;
function Tcl_RegExpMatchObj(interp:PTcl_Interp; textObj:PTcl_Obj; patternObj:PTcl_Obj):cint;extdecl;external;
procedure Tcl_SetNotifier(notifierProcPtr:Tcl_NotifierProcs);extdecl;external;
function Tcl_GetAllocMutex:PTcl_Mutex;extdecl;external;
function Tcl_GetChannelNames(interp:PTcl_Interp):cint;extdecl;external;
function Tcl_GetChannelNamesEx(interp:PTcl_Interp; pattern:PChar):cint;extdecl;external;
function Tcl_ProcObjCmd(clientData:ClientData; interp:PTcl_Interp; objc:cint; objv:array of PTcl_Obj):cint;extdecl;external;
procedure Tcl_ConditionFinalize(condPtr:PTcl_Condition);extdecl;external;
procedure Tcl_MutexFinalize(mutex:PTcl_Mutex);extdecl;external;
function Tcl_CreateThread(idPtr:PTcl_ThreadId; proc:Tcl_ThreadCreateProc; clientData:ClientData; stackSize:cint; flags:cint):cint;extdecl;external;
function Tcl_ReadRaw(chan:PTcl_Channel; dst:PChar; bytesToRead:cint):cint;extdecl;external;
function Tcl_WriteRaw(chan:PTcl_Channel; src:PChar; srcLen:cint):cint;extdecl;external;
function Tcl_GetTopChannel(chan:PTcl_Channel):PTcl_Channel;extdecl;external;
function Tcl_ChannelBuffered(chan:PTcl_Channel):cint;extdecl;external;
function Tcl_ChannelName(chanTypePtr:PTcl_ChannelType):PChar;extdecl;external;
function Tcl_ChannelVersion(chanTypePtr:PTcl_ChannelType):PTcl_ChannelTypeVersion;extdecl;external;
function Tcl_ChannelBlockModeProc(chanTypePtr:PTcl_ChannelType):Tcl_DriverBlockModeProc;extdecl;external;
function Tcl_ChannelCloseProc(chanTypePtr:PTcl_ChannelType):Tcl_DriverCloseProc;extdecl;external;
function Tcl_ChannelClose2Proc(chanTypePtr:PTcl_ChannelType):Tcl_DriverClose2Proc;extdecl;external;
function Tcl_ChannelInputProc(chanTypePtr:PTcl_ChannelType):Tcl_DriverInputProc;extdecl;external;
function Tcl_ChannelOutputProc(chanTypePtr:PTcl_ChannelType):Tcl_DriverOutputProc;extdecl;external;
function Tcl_ChannelSeekProc(chanTypePtr:PTcl_ChannelType):Tcl_DriverSeekProc;extdecl;external;
function Tcl_ChannelSetOptionProc(chanTypePtr:PTcl_ChannelType):Tcl_DriverSetOptionProc;extdecl;external;
function Tcl_ChannelGetOptionProc(chanTypePtr:PTcl_ChannelType):Tcl_DriverGetOptionProc;extdecl;external;
function Tcl_ChannelWatchProc(chanTypePtr:PTcl_ChannelType):Tcl_DriverWatchProc;extdecl;external;
function Tcl_ChannelGetHandleProc(chanTypePtr:PTcl_ChannelType):Tcl_DriverGetHandleProc;extdecl;external;
function Tcl_ChannelFlushProc(chanTypePtr:PTcl_ChannelType):Tcl_DriverFlushProc;extdecl;external;
function Tcl_ChannelHandlerProc(chanTypePtr:PTcl_ChannelType):Tcl_DriverHandlerProc;extdecl;external;
function Tcl_JoinThread(threadId:PTcl_ThreadId; result:pcint):cint;extdecl;external;
function Tcl_IsChannelShared(channel:PTcl_Channel):cint;extdecl;external;
function Tcl_IsChannelRegistered(interp:PTcl_Interp; channel:PTcl_Channel):cint;extdecl;external;
procedure Tcl_CutChannel(channel:PTcl_Channel);extdecl;external;
procedure Tcl_SpliceChannel(channel:PTcl_Channel);extdecl;external;
procedure Tcl_ClearChannelHandlers(channel:PTcl_Channel);extdecl;external;
function Tcl_IsChannelExisting(channelName:PChar):cint;extdecl;external;
function Tcl_UniCharNcasecmp(ucs:PTcl_UniChar; uct:PTcl_UniChar; numChars:culong):cint;extdecl;external;
function Tcl_UniCharCaseMatch(uniStr:PTcl_UniChar; uniPattern:PTcl_UniChar; nocase:cint):cint;extdecl;external;
function Tcl_FindHashEntry(tablePtr:PTcl_HashTable; key:PChar):PTcl_HashEntry;extdecl;external;
function Tcl_CreateHashEntry(tablePtr:PTcl_HashTable; key:PChar; newPtr:pcint):PTcl_HashEntry;extdecl;external;
procedure Tcl_InitCustomHashTable(tablePtr:PTcl_HashTable; keyType:cint; typePtr:PTcl_HashKeyType);extdecl;external;
procedure Tcl_InitObjHashTable(tablePtr:PTcl_HashTable);extdecl;external;
function Tcl_CommandTraceInfo(interp:PTcl_Interp; varName:PChar; flags:cint; procPtr:PTcl_CommandTraceProc; prevClientData:ClientData):ClientData;extdecl;external;
function Tcl_TraceCommand(interp:PTcl_Interp; varName:PChar; flags:cint; proc:PTcl_CommandTraceProc; clientData:ClientData):cint;extdecl;external;
procedure Tcl_UntraceCommand(interp:PTcl_Interp; varName:PChar; flags:cint; proc:PTcl_CommandTraceProc; clientData:ClientData);extdecl;external;
function Tcl_AttemptAlloc(size:cuint):PChar;extdecl;external;
function Tcl_AttemptDbCkalloc(size:cuint; _file:PChar; line:cint):PChar;extdecl;external;
function Tcl_AttemptRealloc(ptr:PChar; size:cuint):PChar;extdecl;external;
function Tcl_AttemptDbCkrealloc(ptr:PChar; size:cuint; _file:PChar; line:cint):PChar;extdecl;external;
function Tcl_AttemptSetObjLength(objPtr:PTcl_Obj; length:cint):cint;extdecl;external;
function Tcl_GetChannelThread(channel:PTcl_Channel):PTcl_ThreadId;extdecl;external;
function Tcl_GetUnicodeFromObj(objPtr:PTcl_Obj; lengthPtr:pcint):PTcl_UniChar;extdecl;external;
function Tcl_GetMathFuncInfo(interp:PTcl_Interp; name:PChar; numArgsPtr:pcint; argTypesPtr:PPTcl_ValueType; procPtr:Tcl_MathProc;
           clientDataPtr:PClientData):cint;extdecl;external;
function Tcl_ListMathFuncs(interp:PTcl_Interp; pattern:PChar):PTcl_Obj;extdecl;external;
function Tcl_SubstObj(interp:PTcl_Interp; objPtr:PTcl_Obj; flags:cint):PTcl_Obj;extdecl;external;
function Tcl_DetachChannel(interp:PTcl_Interp; channel:PTcl_Channel):cint;extdecl;external;
function Tcl_IsStandardChannel(channel:PTcl_Channel):cint;extdecl;external;
function Tcl_FSCopyFile(srcPathPtr:PTcl_Obj; destPathPtr:PTcl_Obj):cint;extdecl;external;
function Tcl_FSCopyDirectory(srcPathPtr:PTcl_Obj; destPathPtr:PTcl_Obj; errorPtr:PPTcl_Obj):cint;extdecl;external;
function Tcl_FSCreateDirectory(pathPtr:PTcl_Obj):cint;extdecl;external;
function Tcl_FSDeleteFile(pathPtr:PTcl_Obj):cint;extdecl;external;
function Tcl_FSLoadFile(interp:PTcl_Interp; pathPtr:PTcl_Obj; sym1:PChar; sym2:PChar; proc1Ptr:Tcl_PackageInitProc;
           proc2Ptr:Tcl_PackageInitProc; handlePtr:PTcl_LoadHandle; unloadProcPtr:Tcl_FSUnloadFileProc):cint;extdecl;external;
function Tcl_FSMatchInDirectory(interp:PTcl_Interp; result:PTcl_Obj; pathPtr:PTcl_Obj; pattern:PChar; types:PTcl_GlobTypeData):cint;extdecl;external;
function Tcl_FSLink(pathPtr:PTcl_Obj; toPtr:PTcl_Obj; linkAction:cint):PTcl_Obj;extdecl;external;
function Tcl_FSRemoveDirectory(pathPtr:PTcl_Obj; recursive:cint; errorPtr:PPTcl_Obj):cint;extdecl;external;
function Tcl_FSRenameFile(srcPathPtr:PTcl_Obj; destPathPtr:PTcl_Obj):cint;extdecl;external;
function Tcl_FSLstat(pathPtr:PTcl_Obj; buf:PTcl_StatBuf):cint;extdecl;external;
function Tcl_FSUtime(pathPtr:PTcl_Obj; tval:Putimbuf):cint;extdecl;external;
function Tcl_FSFileAttrsGet(interp:PTcl_Interp; index:cint; pathPtr:PTcl_Obj; objPtrRef:PPTcl_Obj):cint;extdecl;external;
function Tcl_FSFileAttrsSet(interp:PTcl_Interp; index:cint; pathPtr:PTcl_Obj; objPtr:PTcl_Obj):cint;extdecl;external;
function Tcl_FSFileAttrStrings(pathPtr:PTcl_Obj; objPtrRef:PPTcl_Obj):pPChar;extdecl;external;
function Tcl_FSStat(pathPtr:PTcl_Obj; buf:PTcl_StatBuf):cint;extdecl;external;
function Tcl_FSAccess(pathPtr:PTcl_Obj; mode:cint):cint;extdecl;external;
function Tcl_FSOpenFileChannel(interp:PTcl_Interp; pathPtr:PTcl_Obj; modeString:PChar; permissions:cint):PTcl_Channel;extdecl;external;
function Tcl_FSGetCwd(interp:PTcl_Interp):PTcl_Obj;extdecl;external;
function Tcl_FSChdir(pathPtr:PTcl_Obj):cint;extdecl;external;
function Tcl_FSConvertToPathType(interp:PTcl_Interp; pathPtr:PTcl_Obj):cint;extdecl;external;
function Tcl_FSJoinPath(listObj:PTcl_Obj; elements:cint):PTcl_Obj;extdecl;external;
function Tcl_FSSplitPath(pathPtr:PTcl_Obj; lenPtr:pcint):PTcl_Obj;extdecl;external;
function Tcl_FSEqualPaths(firstPtr:PTcl_Obj; secondPtr:PTcl_Obj):cint;extdecl;external;
function Tcl_FSGetNormalizedPath(interp:PTcl_Interp; pathPtr:PTcl_Obj):PTcl_Obj;extdecl;external;
function Tcl_FSJoinToPath(pathPtr:PTcl_Obj; objc:cint; objv:array of PTcl_Obj):PTcl_Obj;extdecl;external;
function Tcl_FSGetInternalRep(pathPtr:PTcl_Obj; fsPtr:PTcl_Filesystem):ClientData;extdecl;external;
function Tcl_FSGetTranslatedPath(interp:PTcl_Interp; pathPtr:PTcl_Obj):PTcl_Obj;extdecl;external;
function Tcl_FSEvalFile(interp:PTcl_Interp; fileName:PTcl_Obj):cint;extdecl;external;
function Tcl_FSNewNativePath(fromFilesystem:PTcl_Filesystem; clientData:ClientData):PTcl_Obj;extdecl;external;
function Tcl_FSGetNativePath(pathPtr:PTcl_Obj):PChar;extdecl;external;
function Tcl_FSFileSystemInfo(pathPtr:PTcl_Obj):PTcl_Obj;extdecl;external;
function Tcl_FSPathSeparator(pathPtr:PTcl_Obj):PTcl_Obj;extdecl;external;
function Tcl_FSListVolumes:PTcl_Obj;extdecl;external;
function Tcl_FSRegister(clientData:ClientData; fsPtr:PTcl_Filesystem):cint;extdecl;external;
function Tcl_FSUnregister(fsPtr:PTcl_Filesystem):cint;extdecl;external;
function Tcl_FSData(fsPtr:PTcl_Filesystem):ClientData;extdecl;external;
function Tcl_FSGetTranslatedStringPath(interp:PTcl_Interp; pathPtr:PTcl_Obj):PChar;extdecl;external;
function Tcl_FSGetFileSystemForPath(pathPtr:PTcl_Obj):PTcl_Filesystem;extdecl;external;
function Tcl_FSGetPathType(pathPtr:PTcl_Obj):Tcl_PathType;extdecl;external;
function Tcl_OutputBuffered(chan:PTcl_Channel):cint;extdecl;external;
procedure Tcl_FSMountsChanged(fsPtr:PTcl_Filesystem);extdecl;external;
function Tcl_EvalTokensStandard(interp:PTcl_Interp; tokenPtr:PTcl_Token; count:cint):cint;extdecl;external;
procedure Tcl_GetTime(timeBuf:PTcl_Time);extdecl;external;
function Tcl_CreateObjTrace(interp:PTcl_Interp; level:cint; flags:cint; objProc:Tcl_CmdObjTraceProc; clientData:ClientData; 
           delProc:Tcl_CmdObjTraceDeleteProc):PTcl_Trace;extdecl;external;
function Tcl_GetCommandInfoFromToken(token:PTcl_Command; infoPtr:PTcl_CmdInfo):cint;extdecl;external;
function Tcl_SetCommandInfoFromToken(token:PTcl_Command; infoPtr:PTcl_CmdInfo):cint;extdecl;external;
function Tcl_DbNewWideIntObj(wideValue:Tcl_WideInt; _file:PChar; line:cint):PTcl_Obj;extdecl;external;
function Tcl_GetWideIntFromObj(interp:PTcl_Interp; objPtr:PTcl_Obj; widePtr:PTcl_WideInt):cint;extdecl;external;
function Tcl_NewWideIntObj(wideValue:Tcl_WideInt):PTcl_Obj;extdecl;external;
procedure Tcl_SetWideIntObj(objPtr:PTcl_Obj; wideValue:Tcl_WideInt);extdecl;external;
function Tcl_AllocStatBuf:PTcl_StatBuf;extdecl;external;
function Tcl_Seek(chan:PTcl_Channel; offset:Tcl_WideInt; mode:cint):Tcl_WideInt;extdecl;external;
function Tcl_Tell(chan:PTcl_Channel):Tcl_WideInt;extdecl;external;
function Tcl_ChannelWideSeekProc(chanTypePtr:PTcl_ChannelType):Tcl_DriverWideSeekProc;extdecl;external;
function Tcl_DictObjPut(interp:PTcl_Interp; dictPtr:PTcl_Obj; keyPtr:PTcl_Obj; valuePtr:PTcl_Obj):cint;extdecl;external;
function Tcl_DictObjGet(interp:PTcl_Interp; dictPtr:PTcl_Obj; keyPtr:PTcl_Obj; valuePtrPtr:PPTcl_Obj):cint;extdecl;external;
function Tcl_DictObjRemove(interp:PTcl_Interp; dictPtr:PTcl_Obj; keyPtr:PTcl_Obj):cint;extdecl;external;
function Tcl_DictObjSize(interp:PTcl_Interp; dictPtr:PTcl_Obj; sizePtr:pcint):cint;extdecl;external;
function Tcl_DictObjFirst(interp:PTcl_Interp; dictPtr:PTcl_Obj; searchPtr:PTcl_DictSearch; keyPtrPtr:PPTcl_Obj; valuePtrPtr:PPTcl_Obj; 
           donePtr:pcint):cint;extdecl;external;
procedure Tcl_DictObjNext(searchPtr:PTcl_DictSearch; keyPtrPtr:PPTcl_Obj; valuePtrPtr:PPTcl_Obj; donePtr:pcint);extdecl;external;
procedure Tcl_DictObjDone(searchPtr:PTcl_DictSearch);extdecl;external;
function Tcl_DictObjPutKeyList(interp:PTcl_Interp; dictPtr:PTcl_Obj; keyc:cint; keyv:PPTcl_Obj; valuePtr:PTcl_Obj):cint;extdecl;external;
function Tcl_DictObjRemoveKeyList(interp:PTcl_Interp; dictPtr:PTcl_Obj; keyc:cint; keyv:PPTcl_Obj):cint;extdecl;external;
function Tcl_NewDictObj:PTcl_Obj;extdecl;external;
function Tcl_DbNewDictObj(_file:PChar; line:cint):PTcl_Obj;extdecl;external;
procedure Tcl_RegisterConfig(interp:PTcl_Interp; pkgName:PChar; configuration:PTcl_Config; valEncoding:PChar);extdecl;external;
function Tcl_CreateNamespace(interp:PTcl_Interp; name:PChar; clientData:ClientData; deleteProc:Tcl_NamespaceDeleteProc):PTcl_Namespace;extdecl;external;
procedure Tcl_DeleteNamespace(nsPtr:PTcl_Namespace);extdecl;external;
function Tcl_AppendExportList(interp:PTcl_Interp; nsPtr:PTcl_Namespace; objPtr:PTcl_Obj):cint;extdecl;external;
function Tcl_Export(interp:PTcl_Interp; nsPtr:PTcl_Namespace; pattern:PChar; resetListFirst:cint):cint;extdecl;external;
function Tcl_Import(interp:PTcl_Interp; nsPtr:PTcl_Namespace; pattern:PChar; allowOverwrite:cint):cint;extdecl;external;
function Tcl_ForgetImport(interp:PTcl_Interp; nsPtr:PTcl_Namespace; pattern:PChar):cint;extdecl;external;
function Tcl_GetCurrentNamespace(interp:PTcl_Interp):PTcl_Namespace;extdecl;external;
function Tcl_GetGlobalNamespace(interp:PTcl_Interp):PTcl_Namespace;extdecl;external;
function Tcl_FindNamespace(interp:PTcl_Interp; name:PChar; contextNsPtr:PTcl_Namespace; flags:cint):PTcl_Namespace;extdecl;external;
function Tcl_FindCommand(interp:PTcl_Interp; name:PChar; contextNsPtr:PTcl_Namespace; flags:cint):PTcl_Command;extdecl;external;
function Tcl_GetCommandFromObj(interp:PTcl_Interp; objPtr:PTcl_Obj):PTcl_Command;extdecl;external;
procedure Tcl_GetCommandFullName(interp:PTcl_Interp; command:PTcl_Command; objPtr:PTcl_Obj);extdecl;external;
function Tcl_FSEvalFileEx(interp:PTcl_Interp; fileName:PTcl_Obj; encodingName:PChar):cint;extdecl;external;
function Tcl_SetExitProc(proc:Tcl_ExitProc):Tcl_ExitProc;extdecl;external;
procedure Tcl_LimitAddHandler(interp:PTcl_Interp; _type:cint; handlerProc:Tcl_LimitHandlerProc; clientData:ClientData; deleteProc:Tcl_LimitHandlerDeleteProc);extdecl;external;
procedure Tcl_LimitRemoveHandler(interp:PTcl_Interp; _type:cint; handlerProc:Tcl_LimitHandlerProc; clientData:ClientData);extdecl;external;
function Tcl_LimitReady(interp:PTcl_Interp):cint;extdecl;external;
function Tcl_LimitCheck(interp:PTcl_Interp):cint;extdecl;external;
function Tcl_LimitExceeded(interp:PTcl_Interp):cint;extdecl;external;
procedure Tcl_LimitSetCommands(interp:PTcl_Interp; commandLimit:cint);extdecl;external;
procedure Tcl_LimitSetTime(interp:PTcl_Interp; timeLimitPtr:PTcl_Time);extdecl;external;
procedure Tcl_LimitSetGranularity(interp:PTcl_Interp; _type:cint; granularity:cint);extdecl;external;
function Tcl_LimitTypeEnabled(interp:PTcl_Interp; _type:cint):cint;extdecl;external;
function Tcl_LimitTypeExceeded(interp:PTcl_Interp; _type:cint):cint;extdecl;external;
procedure Tcl_LimitTypeSet(interp:PTcl_Interp; _type:cint);extdecl;external;
procedure Tcl_LimitTypeReset(interp:PTcl_Interp; _type:cint);extdecl;external;
function Tcl_LimitGetCommands(interp:PTcl_Interp):cint;extdecl;external;
procedure Tcl_LimitGetTime(interp:PTcl_Interp; timeLimitPtr:PTcl_Time);extdecl;external;
function Tcl_LimitGetGranularity(interp:PTcl_Interp; _type:cint):cint;extdecl;external;
function Tcl_SaveInterpState(interp:PTcl_Interp; status:cint):PTcl_InterpState;extdecl;external;
function Tcl_RestoreInterpState(interp:PTcl_Interp; state:PTcl_InterpState):cint;extdecl;external;
procedure Tcl_DiscardInterpState(state:PTcl_InterpState);extdecl;external;
function Tcl_SetReturnOptions(interp:PTcl_Interp; options:PTcl_Obj):cint;extdecl;external;
function Tcl_GetReturnOptions(interp:PTcl_Interp; result:cint):PTcl_Obj;extdecl;external;
function Tcl_IsEnsemble(token:PTcl_Command):cint;extdecl;external;
function Tcl_CreateEnsemble(interp:PTcl_Interp; name:PChar; namespacePtr:PTcl_Namespace; flags:cint):PTcl_Command;extdecl;external;
function Tcl_FindEnsemble(interp:PTcl_Interp; cmdNameObj:PTcl_Obj; flags:cint):PTcl_Command;extdecl;external;
function Tcl_SetEnsembleSubcommandList(interp:PTcl_Interp; token:PTcl_Command; subcmdList:PTcl_Obj):cint;extdecl;external;
function Tcl_SetEnsembleMappingDict(interp:PTcl_Interp; token:PTcl_Command; mapDict:PTcl_Obj):cint;extdecl;external;
function Tcl_SetEnsembleUnknownHandler(interp:PTcl_Interp; token:PTcl_Command; unknownList:PTcl_Obj):cint;extdecl;external;
function Tcl_SetEnsembleFlags(interp:PTcl_Interp; token:PTcl_Command; flags:cint):cint;extdecl;external;
function Tcl_GetEnsembleSubcommandList(interp:PTcl_Interp; token:PTcl_Command; subcmdListPtr:PPTcl_Obj):cint;extdecl;external;
function Tcl_GetEnsembleMappingDict(interp:PTcl_Interp; token:PTcl_Command; mapDictPtr:PPTcl_Obj):cint;extdecl;external;
function Tcl_GetEnsembleUnknownHandler(interp:PTcl_Interp; token:PTcl_Command; unknownListPtr:PPTcl_Obj):cint;extdecl;external;
function Tcl_GetEnsembleFlags(interp:PTcl_Interp; token:PTcl_Command; flagsPtr:pcint):cint;extdecl;external;
function Tcl_GetEnsembleNamespace(interp:PTcl_Interp; token:PTcl_Command; namespacePtrPtr:PPTcl_Namespace):cint;extdecl;external;
procedure Tcl_SetTimeProc(getProc:Tcl_GetTimeProc; scaleProc:Tcl_ScaleTimeProc; clientData:ClientData);extdecl;external;
procedure Tcl_QueryTimeProc(getProc:Tcl_GetTimeProc; scaleProc:Tcl_ScaleTimeProc; clientData:PClientData);extdecl;external;
function Tcl_ChannelThreadActionProc(chanTypePtr:PTcl_ChannelType):Tcl_DriverThreadActionProc;extdecl;external;
function Tcl_NewBignumObj(value:Pmp_int):PTcl_Obj;extdecl;external;
function Tcl_DbNewBignumObj(value:Pmp_int; _file:PChar; line:cint):PTcl_Obj;extdecl;external;
procedure Tcl_SetBignumObj(obj:PTcl_Obj; value:Pmp_int);extdecl;external;
function Tcl_GetBignumFromObj(interp:PTcl_Interp; obj:PTcl_Obj; value:Pmp_int):cint;extdecl;external;
function Tcl_TakeBignumFromObj(interp:PTcl_Interp; obj:PTcl_Obj; value:Pmp_int):cint;extdecl;external;
function Tcl_TruncateChannel(chan:PTcl_Channel; length:Tcl_WideInt):cint;extdecl;external;
function Tcl_ChannelTruncateProc(chanTypePtr:PTcl_ChannelType):Tcl_DriverTruncateProc;extdecl;external;
procedure Tcl_SetChannelErrorInterp(interp:PTcl_Interp; msg:PTcl_Obj);extdecl;external;
procedure Tcl_GetChannelErrorInterp(interp:PTcl_Interp; msg:PPTcl_Obj);extdecl;external;
procedure Tcl_SetChannelError(chan:PTcl_Channel; msg:PTcl_Obj);extdecl;external;
procedure Tcl_GetChannelError(chan:PTcl_Channel; msg:PPTcl_Obj);extdecl;external;
function Tcl_InitBignumFromDouble(interp:PTcl_Interp; initval:double; toInit:Pmp_int):cint;extdecl;external;
function Tcl_GetNamespaceUnknownHandler(interp:PTcl_Interp; nsPtr:PTcl_Namespace):PTcl_Obj;extdecl;external;
function Tcl_SetNamespaceUnknownHandler(interp:PTcl_Interp; nsPtr:PTcl_Namespace; handlerPtr:PTcl_Obj):cint;extdecl;external;
function Tcl_GetEncodingFromObj(interp:PTcl_Interp; objPtr:PTcl_Obj; encodingPtr:PTcl_Encoding):cint;extdecl;external;
function Tcl_GetEncodingSearchPath:PTcl_Obj;extdecl;external;
function Tcl_SetEncodingSearchPath(searchPath:PTcl_Obj):cint;extdecl;external;
function Tcl_GetEncodingNameFromEnvironment(bufPtr:PTcl_DString):PChar;extdecl;external;
function Tcl_PkgRequireProc(interp:PTcl_Interp; name:PChar; objc:cint; objv:array of PTcl_Obj; clientDataPtr:PClientData):cint;extdecl;external;
procedure Tcl_AppendObjToErrorInfo(interp:PTcl_Interp; objPtr:PTcl_Obj);extdecl;external;
procedure Tcl_AppendLimitedToObj(objPtr:PTcl_Obj; bytes:PChar; length:cint; limit:cint; ellipsis:PChar);extdecl;external;
function Tcl_Format(interp:PTcl_Interp; format:PChar; objc:cint; objv:array of PTcl_Obj):PTcl_Obj;extdecl;external;
function Tcl_AppendFormatToObj(interp:PTcl_Interp; objPtr:PTcl_Obj; format:PChar; objc:cint; objv:array of PTcl_Obj):cint;extdecl;external;
function Tcl_ObjPrintf(format:PChar; args:array of const):PTcl_Obj;extdecl;external;
function Tcl_ObjPrintf(format:PChar):PTcl_Obj;extdecl;external;
procedure Tcl_AppendPrintfToObj(objPtr:PTcl_Obj; format:PChar; args:array of const);extdecl;external;
procedure Tcl_AppendPrintfToObj(objPtr:PTcl_Obj; format:PChar);extdecl;external;
...
type
  ...
  TclStubs = record
      magic : cint;
      hooks : PTclStubHooks;
      tcl_PkgProvideEx : function (interp:PTcl_Interp; name:PChar; version:PChar; clientData:ClientData):cint;extdecl;
      tcl_PkgRequireEx : function (interp:PTcl_Interp; name:PChar; version:PChar; exact:cint; clientDataPtr:PClientData):PChar;
      tcl_Panic : procedure (format:PChar; args:array of const);extdecl;
      ...
      tcl_AppendStringsToObj : procedure (objPtr:PTcl_Obj; args:array of const);extdecl;
      ...
      tcl_AppendResult : procedure (interp:PTcl_Interp; args:array of const);extdecl;
      ...
      tcl_SetErrorCode : procedure (interp:PTcl_Interp; args:array of const);extdecl;
      ...
      tcl_UpVar2 : function (interp:PTcl_Interp; frameName:PChar; part1:PChar; part2:PChar; localName:PChar;
                   flags:cint):cint;
      tcl_VarEval : function (interp:PTcl_Interp; args:array of const):cint;extdecl;
      ...
      tcl_ObjPrintf : function (format:PChar; args:array of const):PTcl_Obj;extdecl;
      tcl_AppendPrintfToObj : procedure (objPtr:PTcl_Obj; format:PChar; args:array of const);extdecl;
    end;
